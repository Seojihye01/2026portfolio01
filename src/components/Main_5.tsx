...
const Main_5: React.FC = () => {
  ...
  const koData: StrategyData = {
    ...
    HYPOTHESIS: { id: '03', title: '가설', content: '영화의 본질적인 감성과 기획 의도를 매거진 형태로 정제하여 전달한다면 이용자의 탐색 피로도를 낮추고 플랫폼 몰입도를 증대시킬 것이다' },
    SOLUTION: { id: '04', title: '해결책', content: '이용자가 제안된 콘텐츠를 주도적으로 발견하는 즐거움을 느낄 수 있도록 단계별 상호작용 흐름을 설계하고 능동적 참여를 통해 결과물에 대한 소유감 부여' },
    KEY_INSIGHT: { id: '05', title: '핵심 발견', content: '행동경제학의 ‘선택의 역설’과 ‘이케아 효과’에 주목하여 초기 콘텐츠 노출을 의도적으로 제한함. 무형의 디지털 공간 속에서 실물을 조작하는 듯한 물리적 감각과 개인화된 큐레이션을 제공함으로써, 이용자에게 결과물에 대한 소유감을 부여하는 경험이 플랫폼 몰입도를 극대화함을 학습 <br /><span class="main5_research_source">이케아 효과 : 소비자가 자신이 직접 만든 제품에 대해 완제품보다 더 높은 가치를 부여하는 심리적 현상 <br/>[ Daniel Mochon, Michael I. Norton, Dan Ariely ]</span>' }
  };
  ...
  const enData: StrategyData = {
    ...
    KEY_INSIGHT: { id: '05', title: 'KEY INSIGHT', content: 'Focusing on behavioural economics—specifically the "Paradox of Choice" and the "IKEA Effect"—I intentionally limited the initial content display to reduce decision fatigue. By providing a physical sensation of touching a real object within a digital space alongside personalised curation, I learned that an experience giving users a true sense of ownership over their results maximises platform engagement<br /><span class="main5_research_source">The IKEA Effect : a cognitive bias in which consumers place a disproportionately high value on products they partially created or assembled themselves <br/>[ Daniel Mochon, Michael I. Norton, Dan Ariely ]</span>' }
  };
