    ...
    <article className="main4_container" data-theme="light">
      <div className="main4_inner">
        <header className="main4_sub_header">
          <div className="main4_sub_left">
            ...
            <div className='main4_sub_set'>
              <p className="main4_sub_tag bold">Personal Project, 100%</p>
            </div>
          </div>
        ...
        <div className="main4_sub_right">
            ...
            <a href="https://www.figma.com/design/t42KMmHFysiPqUtJLJ8hPm/MainProject_Directory.M?node-id=0-1&t=svenyqeYxTdrKkbl-1" target="_blank">MORE INFO ↗&#xFE0E;</a>
        </div>
